import { createPrivateKey, createPublicKey, randomBytes, randomUUID, scrypt as scryptCallback, sign as signData, timingSafeEqual, verify as verifyData } from 'node:crypto';
