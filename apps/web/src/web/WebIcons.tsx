// ─────────────────────────────────────────────────
// An Pardaz Web Portal — Professional SVG Icon System
// Consistent 1.6px stroke, round caps/joins
// NO emoji, NO third-party icon fonts
// ─────────────────────────────────────────────────

interface IcProps { n: string; s?: number; w?: number; fill?: string; className?: string; style?: React.CSSProperties; }

export default function WI({ n, s = 20, w = 1.6, fill, className, style }: IcProps) {
  const base = {
    ...
    style: { flexShrink: 0, display: "inline-block" as const, verticalAlign: "middle" as const, ...style },
  };
  ...
  switch (n) {
    ...
    case "edit":         return <svg {...p}><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 1 1 3 3L12 15l-4 1 1-4z"/></svg>;
    ...
    case "sort":         return <svg {...p}><line x1="21" y1="7" x2="3" y2="7"/><line x1="17" y1="12" x2="7" y2="12"/><line x1="13" y1="17" x2="11" y2="17"/></svg>;
    ...
    case "dots-v":       return <svg {...p}><circle cx="12" cy="5" r="1"/><circle cx="12" cy="12" r="1"/><circle cx="12" cy="19" r="1"/></svg>;
    ...
    case "heart-fill":   return <svg {...p} fill="currentColor" stroke="none"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>;
    ...
    case "qr-code":      return <svg {...p}><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><rect x="5" y="5" width="3" height="3" fill="currentColor"/><rect x="16" y="5" width="3" height="3" fill="currentColor"/><rect x="5" y="16" width="3" height="3" fill="currentColor"/><line x1="14" y1="14" x2="14" y2="14"/><line x1="17" y1="14" x2="17" y2="14"/><line x1="20" y1="14" x2="20" y2="14"/><line x1="20" y1="17" x2="20" y2="17"/><line x1="17" y1="17" x2="17" y2="17"/><line x1="14" y1="20" x2="14" y2="20"/><line x1="17" y1="20" x2="17" y2="20"/><line x1="20" y1="20" x2="20" y2="20"/></svg>;
    case "device":       return <svg {...p}><rect x="5" y="2" width="14" height="20" rx="2"/><line x1="12" y1="18" x2="12.01" y2="18"/></svg>;
    case "chart-line":   return <svg {...p}><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>;
    ...
    case "bank":         return <svg {...p}><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>;
    case "coin":         return <svg {...p}><circle cx="12" cy="12" r="10"/><path d="M12 6v12M9 10h6a3 3 0 0 1 0 6H9"/></svg>;
    case "deposit":      return <svg {...p}><path d="M12 22v-7"/><path d="M9 19l3 3 3-3"/><path d="M20.88 18.09A5 5 0 0 0 18 9h-1.26A8 8 0 1 0 3 16.29"/></svg>;
    case "withdraw":     return <svg {...p}><path d="M12 2v7"/><path d="M9 5l3-3 3 3"/><path d="M20.88 18.09A5 5 0 0 0 18 9h-1.26A8 8 0 1 0 3 16.29"/></svg>;
    ...
    case "mic":          return <svg {...p}><rect x="9" y="2" width="6" height="12" rx="3"/><path d="M5 10a7 7 0 0 0 14 0"/><line x1="12" y1="19" x2="12" y2="22"/><line x1="9" y1="22" x2="15" y2="22"/></svg>;
    ...
    // Platforms / products
    case "sarraf":       return <svg {...p}><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/></svg>;
    case "market":       return <svg {...p}><path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 0 1-8 0"/></svg>;
    case "banner":       return <svg {...p}><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 2v5M8 2v5M2 11h20"/></svg>;
    case "hoosh":        return <svg {...p}><path d="M12 2L14.9 9.26H22L16.04 13.74L18.9 21L12 16.54L5.1 21L7.96 13.74L2 9.26H9.1L12 2Z"/></svg>;
    case "financial":    return <svg {...p}><line x1="12" y1="1" x2="12" y2="23"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>;
    ...
    case "phone":        return <svg {...p}><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.18 2 2 0 0 1 3.6 1h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.7a16 16 0 0 0 6.29 6.29l.97-.93a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 22 16.92z"/></svg>;
    ...
    case "building":     return <svg {...p}><rect x="2" y="3" width="8" height="18"/><rect x="14" y="3" width="8" height="18"/><path d="M2 21h20M6 7h.01M6 11h.01M6 15h.01M18 7h.01M18 11h.01M18 15h.01"/></svg>;
    ...
    case "newspaper":    return <svg {...p}><path d="M4 22h16a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2H8a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2zm0 0a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h2"/><path d="M18 14h-8M15 18h-5M10 6h8v4h-8z"/></svg>;
    ...
    case "translate":    return <svg {...p}><path d="M5 8l6 6"/><path d="M4 14l6-6 2-3"/><path d="M2 5h12M7 2h1"/><path d="m22 22-5-10-5 10M14 18h6"/></svg>;
    case "send":         return <svg viewBox="0 0 24 24" width={s} height={s} fill="currentColor" className={className} style={style}><path d="M22 2L11 13M22 2L15 22l-4-9-9-4z"/></svg>;
    ...
    case "android":      return <svg {...p}><path d="M5 16.5a7 7 0 0 1 14 0"/><path d="M15 11.5L16.9 9a.5.5 0 0 0-.8-.6l-1.9 2.5"/><path d="M9 11.5L7.1 9a.5.5 0 0 1 .8-.6L9.8 11"/><rect x="5" y="16" width="14" height="5" rx="2"/><circle cx="9" cy="14" r=".5" fill="currentColor"/><circle cx="15" cy="14" r=".5" fill="currentColor"/></svg>;
    ...
    case "telegram":     return <svg {...p}><path d="M21.2 5.5L17.8 19.6c-.3 1.1-1 1.4-2 .8l-5.5-4.1-2.7 2.5c-.3.3-.6.4-.9.4l.3-5.4L17 9c.4-.4-.1-.6-.6-.2L7.1 15.3l-5.2-1.6c-1.1-.4-1.2-1.1.2-1.6L19.7 4.1c1 .4 1.8.9 1.5 1.4z"/></svg>;
    ...
    case "twitter":      return <svg {...p}><path d="M4 4l16 16M4 20L20 4"/></svg>;
    ...
    case "sparkle":      return <svg {...p}><path d="M12 3L13.5 8.5H19L14.5 12L16.5 17.5L12 14L7.5 17.5L9.5 12L5 8.5H10.5L12 3Z"/></svg>;
    ...
    case "history":      return <svg {...p}><polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 1 0 .49-4.5"/></svg>;
    case "car":          return <svg {...p}><rect x="1" y="3" width="15" height="13"/><polygon points="16 8 20 8 23 11 23 16 16 16 16 8"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>;
    ...
    case "sofa":         return <svg {...p}><path d="M20 9V6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v3"/><path d="M2 11a4 4 0 0 1 4-4 4 4 0 0 1 4 4v2h4v-2a4 4 0 0 1 4-4 4 4 0 0 1 4 4v4a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1z"/><path d="M6 19v2M18 19v2"/></svg>;
    case "hanger":       return <svg {...p}><path d="M20.38 18H3.62a1 1 0 0 1-.74-1.67L12 7l9.12 9.33A1 1 0 0 1 20.38 18z"/><path d="M12 2a2 2 0 0 1 2 2 2 2 0 0 1-2 2v1"/></svg>;
